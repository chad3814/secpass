...
// modified to to put in a closure, jslint cleanup
'use strict';
...
var AES = (function () {
    ...
    */
    ...
    /*
      AES_Encrypt: encrypt the 16 byte array 'pt_block' with the previously
      expanded key 'key'. Returns encrypted block.
    */

    function AES_Encrypt(pt_block, key) {
        var l = key.length;
        var i;
        var block = pt_block.slice();
    ...
    /*
      AES_Decrypt: decrypt the 16 byte array 'ct_block' with the previously
      expanded key 'key'. Return plain text block.
    */

    function AES_Decrypt(ct_block, key) {
        var l = key.length;
        var i;
        var block = ct_block.slice();
